...
#
# tx_intf.tcl: Tcl script for re-creating project 'tx_intf'
#
#*****************************************************************************************
...
set  fd  [open  "./src/tx_intf_pre_def.v"  w]
if {$ARGUMENT3 eq ""} {
  puts $fd " "
} else {
...
add_files -fileset $obj [list "[file normalize "$origin_dir/tx_intf_tb.v"]"]
# MODIFIED: Set the testbench as the top module for simulation
set_property top tx_intf_tb $obj
...
# MODIFIED: Commented out incompatible properties for Vivado 2021.1
...
# Restoring all detailed report configurations
set obj [get_runs impl_1]
