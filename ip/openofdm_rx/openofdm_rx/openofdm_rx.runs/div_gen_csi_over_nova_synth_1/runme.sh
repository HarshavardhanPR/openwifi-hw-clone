...
HD_PWD='C:/Users/ASUS/Downloads/Openofdm/openofdm-dot11zynq/Wifi/openofdm_rx/openofdm_rx.runs/div_gen_csi_over_nova_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div_gen_csi_over_nova.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div_gen_csi_over_nova.tcl
