...
HD_PWD='C:/Users/ASUS/Downloads/Openofdm/openofdm-dot11zynq/Wifi/openofdm_rx/openofdm_rx.runs/deinter_lut_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log deinter_lut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source deinter_lut.tcl
