...
HD_PWD='C:/Users/ASUS/Downloads/Openofdm/openofdm-dot11zynq/Wifi/openofdm_rx/openofdm_rx.runs/xfft_v9_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xfft_v9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xfft_v9.tcl
