...
#
# Generated by export_simulation on Tue Jul 22 21:58:53 +0530 2025
#
################################################################################
...
'-reset_run' switch to the './deinter_lut.sh' script.

./deinter_lut.sh -reset_run
...
./deinter_lut.sh -noclean_files

For more information on the script, please type './deinter_lut.sh -help'.
