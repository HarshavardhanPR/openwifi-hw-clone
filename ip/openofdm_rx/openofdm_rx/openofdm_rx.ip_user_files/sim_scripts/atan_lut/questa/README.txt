...
#
# Generated by export_simulation on Tue Jul 22 22:01:37 +0530 2025
#
################################################################################
...
'-reset_run' switch to the './atan_lut.sh' script.

./atan_lut.sh -reset_run
...
./atan_lut.sh -noclean_files

For more information on the script, please type './atan_lut.sh -help'.
